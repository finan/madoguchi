  ...
  return (
    <>
      <div className="flex flex-col gap-20">
        <section aria-label="Promotional banners" className="mt-14">
          <h1 className="mb-8">Selamat datang di Jepang</h1>
          <HeroSlider />
        </section>
        <section aria-label="Layanan Perantau" className="mb-14">
          <div className="mb-8">
            ...
            <p>
              ...
              ke tanah air. Dari SIM Card internet, sampai pencairan nenkin
              (dana pensiun) - semua bisa diatur di sini.
            </p>
          </div>
